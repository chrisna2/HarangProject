...
<!----------------------------------- 메인페이지 헤더 [작업 제목] ------------------------------------------------------------->
        <section class="content-header">
          ...
          <!-- 페이지 기록 : 메인에서 부터 현재 페이지 까지의 경로 나열 -->
            ...
            <li class="active">스터디룸 예약[현재 입력할 내용이 없습니다.]</li>
          </ol>
        </section>
<!------------------------------------ 메인페이지 바디 [작업 내용] ------------------------------------------------------------>
						...
						<div class="row">
							<div class="col-md-4">
								<label>시설종류</label> <input type="text" class="form-control"
									placeholder="넌 스터디룸을 예약하려 하고있지. 형은 다안다." disabled>
							</div>
						 ...
						 <div class="form-group col-md-4">
	                  		...
	                  		<select class="form-control">
		                    	<option>스터디룸[대]</option>
		                    	<option>스터디룸[중]</option>
		                    	<option>스터디룸[소]</option>
		                    	<option>세미나실</option>
	                    	</select>
	                	</div>
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<label>시설종류</label> <input type="text" class="form-control"
									placeholder="스터디룸" style="width: 150px" disabled>
							</div>
							
							<div class="col-md-4">
								<label>시설명</label> <input type="text" class="form-control"
									placeholder="스터디룸[대]" style="width: 150px" disabled>
							</div>
							
							<div class="col-md-4">
								<label>호수</label> <input type="text" class="form-control"
									placeholder="공과대학" style="width: 150px" disabled>
							</div>
