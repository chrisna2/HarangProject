							...
							<div class="row">
								...
								<form action="/HarangProject/harangdin?cmd=main" name="search" method="post">
									<div class="input-group no-margin">
											<input type="text" name="keyword" value="${keyword }" class="form-control" style="width: 150px;" placeholder="Search">
											<select class="form-control input-sm pull-right" name="keyfield" style="width: 80px;" placeholder="Search">
								...
								<div class="col-sm-1.5 no-margin pull-right">
									<button type="button" class="btn btn-info.btn-flat">
										<i class="fa fa-user"></i> MyPage</button>
								</div>
