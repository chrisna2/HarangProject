										...
										<c:otherwise>
											<c:forEach items="${schlist}" var="schlist"
												...
												<tr>
													...
													<td><a
														href="/HarangProject/schedule?cmd=A_SCH_CON&s_num=${schlist.s_num}"
														style="color: black">${schlist.s_title} </a></td>
				...
				.fullCalendar(
						{
							...
							eventClick : function(calEvent, jsEvent, view) {
								...
								$
										.getJSON(
												"/HarangProject/ajax?cmd=schecon",
												{
													s_num : calEvent.id
												},
												function(data) {
															...
															.each(
																	function(
																		...
																		$(
																				"#s_location")
																				.text(
																						schconlist.s_location);
																		$(
																				"#s_point")
																				.text(
																						schconlist.s_point);
																		if (null != schconlist.s_rend
																				&& null != schconlist.s_rstart) {
																			$(
																					"#s_rend")
																					.text(
																							schconlist.s_rend);
